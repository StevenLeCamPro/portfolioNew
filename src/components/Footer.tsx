...
const Footer = () => {
    ...
    return (
        <footer id='footer'>
            <div className='bg-blue-400 w-5/6 h-0.5 opacity-10 text-center mx-auto'>
    ...
    >
        ...
        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            <path fillRule="evenodd" clipRule="evenodd" d="M22.23 0H1.77C.79 0 0 .775 0 1.728v20.544C0 23.225.79 24 1.77 24h20.46c.98 0 1.77-.775 1.77-1.728V1.728C24 .775 23.21 0 22.23 0zM7.06 20.452H3.56V9.014h3.5v11.438zM5.31 7.56a2.03 2.03 0 110-4.06 2.03 2.03 0 010 4.06zm15.142 12.892h-3.5v-5.563c0-1.33-.023-3.04-1.854-3.04-1.855 0-2.14 1.45-2.14 2.946v5.657h-3.5V9.014h3.36v1.564h.048c.47-.89 1.62-1.828 3.337-1.828 3.567 0 4.224 2.348 4.224 5.404v6.298z"></path>
        </svg>
    </a>
